...
let MainSidebarComponent = class MainSidebarComponent {
    constructor(router, layoutService) {
        ...
        this.activeMenu = 'hedge-accounting';
...
__decorate([
    Input()
], MainSidebarComponent.prototype, "isCollapsed", void 0);
__decorate([
    Output()
], MainSidebarComponent.prototype, "toggleCollapse", void 0);
__decorate([
    Output()
], MainSidebarComponent.prototype, "menuItemClick", void 0);
