...
let HedgeInstructionsComponent = class HedgeInstructionsComponent {
    constructor(svc) {
        this.svc = svc;
        this.rows = [];
        this.search = '';
    ...
    deleteRow(row) { this.pendingDeleteId = row.instruction_id || null; this.showConfirmDelete = true; }
    async confirmDelete() {
...
], HedgeInstructionsComponent.prototype, "onResize", null);
HedgeInstructionsComponent = __decorate([
    Component({
...
], HedgeInstructionsComponent);
export { HedgeInstructionsComponent };
//# sourceMappingURL=hedge-instructions.component.js.map