...
let MurexBookingComponent = class MurexBookingComponent {
    constructor(svc) {
        this.svc = svc;
        this.rows = [];
        this.search = '';
        ...
        this.columnDefs = [
            ...
            { field: 'currency_pair', headerName: 'Currency Pair', width: 180, cellRenderer: (p) => {
...
], MurexBookingComponent.prototype, "onResize", null);
MurexBookingComponent = __decorate([
    Component({
...
], MurexBookingComponent);
export { MurexBookingComponent };
//# sourceMappingURL=murex-booking.component.js.map