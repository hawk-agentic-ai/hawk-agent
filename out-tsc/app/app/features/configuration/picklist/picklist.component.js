...
let PicklistComponent = class PicklistComponent {
    constructor() {
        ...
        this.columnDefs = [
            ...
            { field: 'code', headerName: 'Code', width: 150, cellRenderer: (p) => {
        ...
        this.gridOptions = { pagination: true, paginationPageSize: 10, animateRows: true, context: { componentParent: this } };
...
//# sourceMappingURL=picklist.component.js.map