...
import { AllocationEngineService, AllocationRow } from './allocation-engine.service';
...
export class ApportionmentTableComponent implements OnInit {
  rows: AllocationRow[] = [];
  search = '';
  ...
  showDialog = false;
  selected: AllocationRow | null = null;
  private gridApi: any;
  ...
  constructor(private svc: AllocationEngineService) {}
  ...
  viewRow(row: AllocationRow){ this.selected = row; this.showDialog = true; }
